        ...
        for record in self:
            ...
            if duplicado:
                raise ValidationError(
                    "El prefijo '%s' ya lo usa la categoria '%s'. Cada "
                    "categoria debe tener un prefijo de correlativo unico "
                    "para evitar que se dupliquen las referencias de "
                    "producto." % (record.caa_corr, duplicado.name)
                )
